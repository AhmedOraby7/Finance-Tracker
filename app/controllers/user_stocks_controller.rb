class UserStocksController < ApplicationController
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'Stock Is Successfully Removed from Portfolio' }
  ...
  private
    ...
    def user_stock_params
      params.require(:user_stock).permit(:user_id, :integer, :stock_id)
    end
end
